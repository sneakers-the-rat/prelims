...
\draft{I want to be exceedingly clear that I am not shaming anyone for
...
\idea{start with discussion of what infrastructure is -- making things
...
\draft{A lot of this is happening and being worked on!!! this document is an
...
\draft{what's different about this? we're not describing a ``new database system'' but a way to make every ``new database system'' add functionality to the system rather than be
independent of it.}

\draft{what are the goals of standardization? - external inspection - labor
deduplication - increased access (and so it can't be complicated) -
interoperability}

\draft{what are the traditional costs of standardization? - flexibility -
learning curve}

\draft{Acknowledgements (make sure to double check spelling!!!): * Lauren E.
...
mike for letting me always go rogue, santiago \& matt for being on the committee}
...
voting member of the General Assembly. \cite{woolKnowledgeNetworksHow2020a},\end{leftbar}
...
\cite{woolKnowledgeNetworksHow2020a},\end{leftbar}

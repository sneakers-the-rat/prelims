\documentclass[nohyper]{tufte-book-jls}
\usepackage{tufte-jls-base}
...
\emph{free} \sidenote{In this paragraph I am of course only referring to
...
\item
  ...
  it\sidenote{which, to be clear, is a valid feeling and is reflective
...
semi-stable jumble\sidenote{A \emph{lovely} jumble! that probably has a
...
duplication\sidenote{Thanks a lot to the one-and-only stunning and
...
\href{https://github.com/BrainCOGS}{public}\sidenote{\begin{leftbar}
...
us afloat. There are far too many projects to name here\sidenote{That we
...
Borders:N}. I don't expect a lot of controvery here\sidenote{but I am
...
grants\sidenote{granting agencies seem to love funding new databases,
...
can upload and the speed at which it can serve files\sidenote{As I am
...
Bittorrent\sidenote{peer to peer systems are, maybe predictably, a whole
...
files that are small \textasciitilde KB summaries\sidenote{Hashes} of a
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{/Users/jonny/git/sneakers-the-rat.github.io/_preblog/assets/images/torrent/0_upload-01.png}
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{/Users/jonny/git/sneakers-the-rat.github.io/_preblog/assets/images/torrent/1_download-01.png}
...
\includegraphics[width=\linewidth]{/Users/jonny/git/sneakers-the-rat.github.io/_preblog/assets/images/torrent/2_download-01.png}
\includegraphics[width=\linewidth]{/Users/jonny/git/sneakers-the-rat.github.io/_preblog/assets/images/torrent/3_download-01.png}
\includegraphics[width=\linewidth]{/Users/jonny/git/sneakers-the-rat.github.io/_preblog/assets/images/torrent/4_download-01.png}
...
peer\sidenote{or, in the parlance of bittorrent, a
...
largest informational tragedies of the past decade: what.cd\sidenote{for
...
commercially viable --- or just losing them in a fire \cite{rosenDayMusicBurned2019},\sidenote{\begin{leftbar}  "Among the incinerated Decca masters were recordings by titanic
...
arcana of digital music formats, spectral analysis\sidenote{The average
...
support a library of the entirety of human music output\sidenote{Though
...
supportive\sidenote{Mostly. You know how the internet goes\ldots{}}
...
databases like figshare\sidenote{No shade to Figshare, which, among
...
features and design, but you can still send anyone\sidenote{dont @ me
...
databases\sidenote{though there are subtleties to the terminology, with
...
aspirational due to the small number of contributors\sidenote{I am the
...
ingloriously onto Twitter\sidenote{no citation needed, right? if there

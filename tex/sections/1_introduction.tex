...
\draft{(this might be a good place for a little compression algorithm toy example, like rather than representing a video that is like all black background but single white spot moving around as like all pixel values through all time, you might find some more efficient representation.)}

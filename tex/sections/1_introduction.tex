...
\draft{large part of history of phonetics research has been dissecting individual cues and assessing how they affect perception\cite{schertzPhoneticCueWeighting2020}, unfortunately they seem to have arrived at the conclusion "what perceptual features are necessary for the recognition of phonetic categories? none"\cite{HaskinsLaboratories2020}. This line of work stems from assuming that the mapping and the feature space is static, and there are these reliable cues, present across speakers, that are the constitutive feature of language (the P space). The inability to imagine the auditory soltuion to the problem ultimately drove the primacy of motor theories of language.}
